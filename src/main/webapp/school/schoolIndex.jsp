...
<div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures">
    <div class="nano">
        <div class="nano-content">
            <ul>
                <div class="logo"><a href="${pageContext.request.contextPath}/toScIndex"><!-- <img src="${pageContext.request.contextPath}/assets/images/logo.png" alt="" /> --><span>学校竞赛系统</span></a></div>
                ...
                <li><a class="sidebar-sub-toggle"><i class="ti-home"></i>首页<span class="sidebar-collapse-icon ti-angle-down"></span></a>
                    <ul>
                        <li><a href="${pageContext.request.contextPath}/toScIndex">首页</a></li>
                    </ul>
                </li>

                <li class="label">操作</li>
                <li><a href="${pageContext.request.contextPath}/toVerifyCompetition" target="iframe_pro"><i class="ti-user"></i> 查看正在申请的比赛</a></li>
                <li><a href="${pageContext.request.contextPath}/toAllCompetition" target="iframe_pro"><i class="ti-layout-grid2-alt"></i> 全部比赛</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="float-right">
                    ...
                    <div class="dropdown dib">
                        <div class="header-icon" data-toggle="dropdown">
                                <span class="user-avatar">欢迎你，${school.schoolAccount}
...
<div class="content-wrap">
    <div class="main" style="height: 650px">
        <iframe class="scroll" name="iframe_pro" id="ghrzFrame" src="${pageContext.request.contextPath}/toVerifyCompetition" height="100%" width="100%">
