                ...
                <div class="col-lg-8 p-r-0 title-margin-right">
                    <div class="page-header">
                        <div class="page-title">
                            <button type="button" class="btn btn-default m-b-10" onclick="toVerifyCompetition()">查看正在申请的比赛</button>
                            <button type="button" class="btn btn-primary btn-outline m-b-10 m-l-5" onclick="toAllCompetition()">全部比赛</button>
                                    ...
                                    <table class="table table-hover ">
                                        ...
                                        <c:forEach items="${competitionList}" var="competition">
                                            <tr>
                                                ...
                                                <td>
                                                    <a style="color: #ff4081" href="${pageContext.request.contextPath}/auditPassCompOne?compId=${competition.compId}">审核通过</a>>
                                                    <a style="color: #ff4081" href="${pageContext.request.contextPath}/auditNoPassCompOne?compId=${competition.compId}">审核不通过</a>>
                                                </td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
