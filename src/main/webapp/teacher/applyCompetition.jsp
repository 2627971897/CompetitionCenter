...
<form method="post" action="${pageContext.request.contextPath}/applyCompetition">
    ...
    是否提交作品：<input type="radio" name="isPro" value="N" checked/>不提交作品
    <input type="radio" name="isPro" value="Y"/>提交作品<br>
    可参赛性质：<input type="radio" name="isPer" value="1" checked/>个人
    <input type="radio" name="isPer" value="2"/>团队
    <input type="radio" name="isPer" value="3"/>都可<br>
