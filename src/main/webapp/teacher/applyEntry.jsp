                ...
                <div class="col-lg-8 p-r-0 title-margin-right">
                    <div class="page-header">
                        <div class="page-title">
                            <button type="button" class="btn btn-default m-b-10" onclick="toApplyEntry()">正在申请中</button>
                            <button type="button" class="btn btn-primary btn-outline m-b-10 m-l-5" onclick="toAllEntry()">全部申请</button>
                                    ...
                                    <table class="table table-hover ">
                                        ...
                                        <c:forEach items="${entryList}" var="entry">
                                            <tr>
                                                ...
                                                <td>
                                                    <a style="color: #ff4081" href="${pageContext.request.contextPath}/auditPassEntryOne?entryId=${entry.entryId}">审核通过</a>>
                                                    <a style="color: #ff4081" href="${pageContext.request.contextPath}/auditNoPassEntryOne?entryId=${entry.entryId}">审核不通过</a>>
                                                </td>
                                                <td>
